...
export default function ReconciliationPage() {
  ...
  const summary = summaryRaw as ReconciliationSummary | undefined;
    ...
    <AppShell title="Financial Reconciliation">
      <div className="space-y-6 p-6">
        <AdminPageHeader
          ...
          description="Villa settled totals vs cash received. Advance credit gaps are informational — only excess cash triggers alerts."
        ...
        {summary && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="stat-card">
              ...
              <div className="mt-1">{healthBadge(summary.financialHealth.status)}</div>
            </div>
            <div className="stat-card">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="stat-card-value">{summary.financialHealth.criticalAlerts}</div>
                </div>
              </div>
            </div>
            <div className="stat-card">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="stat-card-label">Unresolved Alerts</div>
                  <div className="stat-card-value">{summary.financialHealth.unresolvedAlerts}</div>
                </div>
              </div>
            </div>
            <div className="stat-card">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="stat-card-value">{summary.financialHealth.recentPayments7Days}</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <table className="table">
              <thead className="table-head">
                <tr>
                  ...
                  <th scope="col" className="table-th">Unexplained</th>
                ...
                {alerts.length === 0 ? (
                  ...
                  alerts.map((alert) => (
                    <tr key={alert.id} className="table-row">
                      ...
                      <td className="table-td">{cycleLabel(alert)}</td>
                      ...
                      <td className="table-td font-mono text-fg-secondary">
                        {alert.creditApplied > 0 ? `₹${formatMoney(alert.creditApplied)}` : "—"}
                      </td>
                      <td className="table-td font-mono">
                        {(alert.unexplainedDifference ?? alert.difference) > 0
