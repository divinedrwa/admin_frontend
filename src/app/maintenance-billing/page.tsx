...
export default function MaintenanceBillingPage() {
  ...
  const [users, setUsers] = useState<Array<{ id: string; name: string; villa?: { villaNumber: string } }>>([]);
            ...
            {createOpen && (
              ...
              >
                ...
                <label className="flex flex-col gap-1 text-sm">
                  <span className="text-gray-600">Month (YYYY-MM)</span>
                  <input
                  ...
                  {cycles.map((c) => (
                    <tr key={c.id} className="border-t border-gray-100">
                      <td className="px-4 py-3 font-medium text-gray-900">
                        <div>{c.cycleKey}</div>
                        <div className="text-gray-500 text-xs">{c.title}</div>
                      </td>
                      ...
                      <td className="px-4 py-3">
                        <button type="button" className="text-blue-600 text-xs font-semibold hover:underline" onClick={() => openEdit(c)}>
                          Edit
                        </button>
                      </td>
                    </tr>
