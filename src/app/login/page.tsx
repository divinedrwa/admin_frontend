        ...
        <form onSubmit={onSubmit} className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl p-8 space-y-6 border border-white/20">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-100">
            ...
            <p className="text-xs text-gray-600 mb-2">
              After <code className="font-mono">prisma:seed-demo</code>, use{" "}
              <span className="font-medium">admin</span> /{" "}
              <span className="font-medium">admin123</span> with the seeded society. Residents and
              guards sign in from the mobile app.
            </p>
            <div className="text-xs text-gray-600 space-y-1.5">
              <div className="flex justify-between items-center bg-white/50 px-2 py-1 rounded">
                ...
                <code className="font-mono text-blue-600">admin / admin123</code>
              </div>
            </div>
          </div>
